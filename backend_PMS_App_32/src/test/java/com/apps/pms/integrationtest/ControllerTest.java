package com.apps.pms.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PMS_App", n.getAttribute("Namespace"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM pms.Bus");
    jdbcTemplate.execute("DELETE FROM pms.Trip");
    jdbcTemplate.execute("DELETE FROM pms.Driver");
    jdbcTemplate.execute("DELETE FROM pms.Route");
     jdbcTemplate.execute("DELETE FROM pms.BusTrips");
