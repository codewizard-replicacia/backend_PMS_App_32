...
import com.apps.pms.converter.DurationConverter;
import com.apps.pms.converter.UUIDToByteConverter;
import com.apps.pms.converter.UUIDToStringConverter;
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"TripId\""), schema = "\"pms\"")
